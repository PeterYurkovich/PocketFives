<template>
  <div>
    ...
    <div class="fixed top-0 left-0 w-full h-full bg-black -z-20">
      <div class="fixed top-1/3 left-1/3 -z-10 blur-sm">
        <svg class="absolute w-[450px] h-[450px] rotate-[215deg]">
          <g transform="scale(12 12)">
            <path
              class=""
              d="M34.592,20.101c1.006,1.808,2.146,3.854,1.892,7.08c-0.298,3.947-2.771,6.509-6.785,7.023
              ...
              c1.256,1.929,2.707,3.8,4.108,5.608c1.983,2.56,4.034,5.204,5.689,8.177L34.592,20.101z"
            />
          </g>
        </svg>
      </div>
      <div
        class="fixed grid grid-cols-3 animate-spin-slow top-1/3 left-1/3 bg-gradient-to-r from-orange-400 to-purple-400 h-96 w-96 blur-3xl -z-20"
      >
        <div class="bg-black animate-elongate-horizontal" />
